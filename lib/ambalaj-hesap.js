...
function ambalajOnerileri(ihtiyac, variants) {
  ...
  /** İhtiyaca en yakın: büyük ambalajdan küçüğe yerleştir (greedy büyükten). */
  let enYakin = null;
  if (g1 && g1.miktarToplam >= need - 1e-6) enYakin = planKlon(g1);
  else if (tamBolunmus && tamBolunmus.miktarToplam >= need - 1e-6) enYakin = planKlon(tamBolunmus);
  else enYakin = planKlon(azAtik);
